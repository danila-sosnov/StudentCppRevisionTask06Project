...
*
*	Шахматная пешка - это самая слабая шахматная фигура, но во время игры может
*	превратиться в любую шахматную фигуру кроме Короля.
*	Предположим, пешка ходит только ВПЕРЁД по вертикали и только НА ОДНУ клетку.
*	Даны две различные клетки шахматной доски, определите, может ли пешка попасть
*	с первой клетки на вторую одним ходом и стать после этого любой фигурой.
*
*	Примечание
...
*	3) Не забудьте про механизм "защиты от дурака". Если пользователь задаёт неверные
*	координаты клеток, то функция должна возвратить булевское значение false.
*	4) Для решения достаточно встроенных в язык арифметических операций,
